                ...
                <div className="relative py-20 lg:py-32 overflow-hidden">
                    <div className="absolute inset-0 z-0">
                        <img
                            ...
                            className="w-full h-full object-cover opacity-50 dark:opacity-80"
                        />
                        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-slate-50/90 to-slate-50 dark:via-slate-900/95 dark:to-slate-900"></div>
                    </div>
                        ...
                        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                            <div className="lg:w-1/2">
                                <div className="relative rounded-3xl overflow-hidden shadow-2xl transform hover:scale-[1.02] transition-transform duration-500">
                                    <img
                                        src="https://images.squarespace-cdn.com/content/v1/609d6b639cd5c8629c9d1012/1667835533753-0YLDTCEBW2HJ483F4P7Y/unsplash-image-uMz8NJp_xpk.jpg"
                                        alt="Overview"
